...
static void _refresh_data() 
{
    ...
    remote_control.robot_speed *= REMOTE_SPEED_FACTOR;
    remote_control.turn_speed *= REMOTE_TURN_FACTOR;
...
{   
    ...
    pid_speed = pid_create(&pid_speed_ctrl, &current_robot_speed, &target_angle_offset, &remote_control.robot_speed, kp_speed, ki_speed, kd_speed); 
